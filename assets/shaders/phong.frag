...
vec3 PointLight(vec3 cameraPosition, vec3 position, LightData light, MaterialData matter) {
    // mesh normal
    vec3 n = normal;
...
vec3 SpotLight(vec3 cameraPosition, vec3 position, LightData light, MaterialData matter) {
    // mesh normal
    vec3 n = normal;
    // direction :light to mesh
    ...
    float dotRV = dot(r, v);
    vec3 baseColor = material.baseColor;
    baseColor = texture(texture1, UV).xyz;
...
vec3 DirectionLight(vec3 cameraPosition, vec3 position, LightData light, MaterialData matter) {
    // mesh normal
    vec3 n = normal;
    // direction :light to mesh
